...
abline(h=(seq(0,100,25)), col="lightgray", lty="dotted")
## Pink 2016 P/A
r$ppa16 <- as.factor(r$ppa16) #Need to change character to factor for pch to work as numeric
...
abline(h=(seq(0,100,25)), col="lightgray", lty="dotted")
## Chum 2015 P/A
r$cpa15 <- as.factor(r$cpa15) #Need to change character to factor for pch to work as numeric
plot(pca$scores[,1], pca$scores[,2], pch=c(16,17)[r$cpa15], col=c("grey","darkgreen")[r$cpa15], 
...
abline(h=(seq(0,100,25)), col="lightgray", lty="dotted")
## Chum 2016 P/A
r$cpa16 <- as.factor(r$cpa16) #Need to change character to factor for pch to work as numeric
