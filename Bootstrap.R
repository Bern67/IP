...
vc$c <- with(vc,ifelse(vc$VWI_Floor <= 3.1, "CC",#Constrained Canyon; from VWI analysis
                              ifelse(vc$VWI_Floor > 3.1, "UV", "")))#Unconstrained Valley
...
p15 <- boot(data = fc, statistic =c_p15, strata=fc$c,R = 5000)
p15
plot(p15,index=1)
plot(p15,index=2)
...
c15 <- boot(data = fc, statistic =c_c15, strata=fc$c,R = 5000)
c15
plot(c15,index=1)
plot(c15,index=2)
# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
...
p16 <- boot(data = fc, statistic =c_p16, strata=fc$c,R = 5000)
p16
plot(p16,index=1)
plot(p16,index=2)
# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
...
c16 <- boot(data = fc, statistic =c_c16, strata=fc$c,R = 5000)
c16
plot(c16,index=1)
plot(c16,index=2)
# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
...
p15 <- boot(data = fc, statistic =g_p15, strata=fc$geol,R = 5000)
p15
plot(p15,index=1)
plot(p15,index=2)
# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
...
c15 <- boot(data = fc, statistic =g_c15, strata=fc$geol,R = 5000)
c15
plot(c15,index=1)
plot(c15,index=2)
# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
...
p16 <- boot(data = fc, statistic =g_p16, strata=fc$geol,R = 5000) # Needs to be large enough to represent pop distribution for stable estimate of parameter
p16
plot(p16,index=1)
plot(p16,index=2)
# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
...
(c16 <- boot(data = fc, statistic =g_c16, strata=fc$geol,R = 5000))
plot(c16,index=1)
plot(c16,index=2)
# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
(ci7<-boot.ci(c16, index=1,type="bca",conf = 0.975))
...
#habcat <- read.csv("ip_habcat.csv")
t <- habcat[,c(1,4)] ## Trib vs mainstem catagories (11 vs 38, respectively)
...
aggregate(cbind(GRADIENT,MEANANNCMS)~t,mean, data=hs)
aggregate(cbind(GRADIENT,MEANANNCMS)~t,median, data=hs)
aggregate(cbind(GRADIENT,MEANANNCMS)~t,max, data=hs)#
aggregate(cbind(GRADIENT,MEANANNCMS)~t,min, data=hs)
median(with(hs,GRADIENT))
median(with(hs,MEANANNCMS))
boxplot(hs$MEANANNCMS~r$cpa15)# Chum p/a for 2015

#Redd counts
redd <-read.csv("redd.csv")
redd <- redd[,-1]

s$size <- as.factor(with(hnl2,ifelse( h$MEANANNCMS < 2.5, 's', "l")))#based on PCA & above boxplot
print(table(s$size))
rm(hnl2)
...
ci2$bca[1,c(4:5)]# large
(m1 <- mean(p15$t[,1]))#Bootstrap mean corrected for bias, report this mean
(m2 <- mean(p15$t[,2]))#for large
...
plot(c15,index=2)# large

# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
ci3<-boot.ci(c15, index=1,type="bca",conf = 0.975) 
ci4<-boot.ci(c15, index=2,type="bca",conf = 0.975)
ci3$bca[1,c(4:5)]# BCa 97.5%CI, for small
ci4$bca[1,c(4:5)]# for lg
(m3 <- mean(c15$t[,1]))#Bootstrap mean corrected for bias, report this mean
(m4 <- mean(c15$t[,2]))#for lg
...
ci5<-boot.ci(p16, index=1,type="bca",conf = 0.975) 
ci6<-boot.ci(p16, index=2,type="bca",conf = 0.975)
ci5$bca[1,c(4:5)]# BCa 97.5%CI
ci6$bca[1,c(4:5)]# lg
(m5 <- mean(p16$t[,1]))#Bootstrap mean corrected for bias, report this mean
(m6 <- mean(p16$t[,2]))# for lg
...
# Bonferroni adj. Alpha=0.1/(2I), I=#Groups,& BCa is corrected CI preffered by statisticians (Manley pg.58)
(ci7<-boot.ci(c16, index=1,type="bca",conf = 0.975))
ci7$bca[1,c(4:5)]# BCa 97.5%CI, small
(ci8<-boot.ci(c16, index=2,type="bca",conf = 0.975))
ci8$bca[1,c(4:5)]# lg
(m7 <- mean(c16$t[,1]))#Bootstrap mean corrected for bias, report this mean
(m8 <- mean(c16$t[,2]))#for lg
...
bt4 <- data.frame(sp=c("p","p","c","c","p","p","c","c"), yr=c(15,15,15,15,16,16,16,16),
       ...
       w_ave=c(m1,m2,m3,m4,m5,m6,m7,m8),lci=c(ci1$bca[1,c(4)],ci2$bca[1,c(4)],ci3$bca[1,c(4)],
    ci4$bca[1,c(4)],ci5$bca[1,c(4)],ci6$bca[1,c(4)],ci7$bca[1,c(4)],ci8$bca[1,c(4)]),
